...
function BodyOne() {
  return (
    <div className="bg-papaya">
      <StarBg/>
      <div className=" py-64 text-base text-3xl md:text-5xl">
        <motion.div
          initial={{ opacity: 0 }}
        ...
        >
          <Parallax speed={10}>
            <p className="text-sorbet pb-6">King</p>
            <svg
              className="w-1/3 md:w-1/5 mx-auto"
              viewBox="0 0 85 84"
              fill="none"
            ...
            <p className="text-sorbet pt-5 md:pt-6">von Rosenvinge</p>
          </Parallax>
        </motion.div>
      </div>
      {/* <div className="md:hidden bg-papaya py-64 text-base text-3xl md:text-5xl">
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
